      ...
      <div className='flex flex-col lg:flex-row justify-between w-full'>
        <form className='w-full lg:w-2/5 space-y-5 bg-[#f2f2f2] p-5 rounded-xl'>
          ...
          <div className='flex flex-col'>
            ...
            <input
              className='py-3 px-2 rounded-lg hover:shadow-[rgb(0,_0,_0,_0.24)_0px_3px_8px] transition-all'
              type="text"
              name='userName'
              id="userName"
        ...
        <div className='flex flex-col items-center w-full lg:w-2/4 my-5'>
          ...
          <p className='text-center text-sm pt-4 text-[#898888]'>
            ...
            need assistance with your travel plans, please don't hesitate to reach
            out. Our tean is here to assist every step of the way. Simply fill out the
            form below, and we'll be in touch shortly.</p>
        </div>
      </div>
    </div>
  )
